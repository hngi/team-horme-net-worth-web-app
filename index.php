                                    ...
                                    <div class="row">
                                        <div class="form-inline col-md-6">
                                            <input
                                                ...
                                                name="firstname"
                                                id="firstName"
                                                pattern="[a-z A-Z]{3,}" title="Please enter at least 3 characters"
                                    ...
                                    <div class="form-group m-1 mt-3">
                                     <small style="color:red; font-size:12px"> <?php echo $email_error; ?></small>
                                        <input
                                            ...
                                            name="email"
                                            id="email"
                                            pattern="[a-zA-Z0-9]{3,}@[a-z]{3,}[.]{1}[a-z]{2,}" title="Please enter a valid email address"
                                            placeholder="Email"
                                    ...
                                    <div class="form-group m-1 mt-3">
                                       <small style="color:red; font-size:12px"> <?php echo $password_error; ?></small>
                                        <input
                                            ...
                                            name="password"
                                            id="password1"
                                            pattern="[a-zA-Z0-9]{8,}" title="password must be 8 characters or more"
