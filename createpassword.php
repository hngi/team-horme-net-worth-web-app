...
include("process/reset_password_process");
?>
        ...
        <!--Form Container-->
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                    ...
                    <div class="form_container input-field1">
                        <input type="password" class="form-control input_pass1" value="" minlength="5" placeholder="New Password *" style="color: white;">
                    </div>
                    <div class="form_container input-field2">
                        <input type="password" class="form-control input_pass2" value="" minlength="5" placeholder="Confirm Password *" style="color: white;">
                    </div>
                    ...
                    <div class="text-center small footer">Not yet Registered? <a href="index.php" class="bottom_signup"> Sign up</a></div>
</form>
	</div>
	</body>
	</html>
